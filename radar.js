...
const config = {
  ...
  webhook: {
    url: 'https://discord.com/api/webhooks/1317640615084822548/wi09AmtZWOdTt4jSZCuMx9-Wp3Up6jioshADFfMNBbdK2bDzYMbZTwMcOko51Q6aemaO',
  },
  pterodactyl: {
    apiUrl: 'https://panel.pluox.xyz/api/application',
    apiKey: 'ptla_LWUCTkojCER3KsOS0hCQNBrrpM9blZu4VC2jLqPytlH',
  },
  scan: {
    interval: 3 * 60 * 1000,
